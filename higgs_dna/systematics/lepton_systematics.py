...
def tauE_sf(events, year, central_only, input_collection, working_point = "none"):
    ...
    return variations
def highptmuonsfnew(events, year, central_only, input_collection, working_point = "none"):
    required_fields = [
...
def highptmuonsf(event):
    ...
    event["weight_muon_highptid_up"]=event['weight_nonisomuon_highptid_sf_SelectedMuon_noiso_up']
    event["weight_muon_highptid_central"]=event['weight_nonisomuon_highptid_sf_SelectedMuon_noiso_central']
    event["weight_muon_highptid_down"]=event['weight_nonisomuon_highptid_sf_SelectedMuon_noiso_down']
    return event
