...
python scripts/run_analysis.py --sample_list "ZGToLLG_01J_5f_lowMLL_lowGPt_TuneCP5_13TeV-amcatnloFXFX-pythia8"s --config "metadata/zgamma_signal.json" --log-level "DEBUG" --n_cores 5 --output_dir /eos/user/s/shsong/HiggsDNA/smzg --unretire_jobs --short --batch_system "local"
